...
export default function GuessAudio() {
  ...
  return (
    <section className="flex gap-3 flex-col items-center justify-center max-w-screen-lg mx-auto">
      <h1 className="font-bold text-3xl text-center my-2 underline underline-offset-4 mb-2">Guess the Letter from Audio</h1>
      <form className="flex flex-col gap-3" autoComplete='off' onSubmit={checkAns}>
        <div className="flex gap-2 select-none cursor-default font-serif">
          <div ref={audioIconRef} role='button' onClick={() => playAudio(client ? randMorse: "")} className="group relative text-5xl bg-white/10 size-32 rounded-lg grid place-content-center border border-white/15  hover:bg-white/15 transition-opacity">
