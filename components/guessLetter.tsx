		...
		<section className="flex gap-3 flex-col items-center justify-center max-w-screen-lg mx-auto">
			...
			>
				<div className="flex gap-2 select-none cursor-default font-serif">
					<button
						type="button"
						onClick={() => playAudio(randMorse)}
						className="relative text-5xl bg-white/10 size-32 rounded-lg grid place-content-center border border-white/15 hover:bg-white/15 transition"
					>
						<span
							title="Play Audio"
							className="z-10 absolute -top-2 -left-2 bg-white p-1 rounded-full grid place-content-center hover:scale-110 transition-transform"
						>
