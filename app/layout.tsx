...
export const metadata: Metadata = {
	title: "Morse Code",
	description:
		"Learn and Play around with Morse Code. Morse Code Guessing Games and Converter",
	generator: "Next.js",
			...
			<body className={`${inter.className} bg-black/90`}>
				<main className="min-h-dvh">
					...
					<div className="flex min-h-[calc(100dvh-64px)] relative">
						<p className="sr-only">
							Learn Morse Code with animated pictures. Morse Code Guessing
							games. Morse Code to Text to Audio converter.
						</p>
						<SideBar />
						<div className="basis-full flex flex-col px-2 pt-2">
							<div className="basis-full pb-2">{children}</div>
							<Footer />
						</div>
					</div>
				</main>
