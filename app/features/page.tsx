	...
	return (
		<div>
			...
			<ul className="font-sans [list-style-type:circle] ml-10 text-neutral-200 *:leading-8">
				...
				<li className={done}>
					Save morse code as audio file in{" "}
				...
				<li>
					Highlight current playing word in{" "}
					<Link href="/convert" className="link">
						convert
					</Link>{" "}
					page and{" "}
				...
				<li>
					Options to include numbers, alphabets or punctuations in Guessr Page.
				</li>
			</ul>
		</div>
	);
